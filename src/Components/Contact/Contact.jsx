    ...
    <body>
      <div className='contact w-full h-full flex flex-col bg-[#1C1C1C] '>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col m-2 gap-4 pt-200 px-40 items-center mx-auto'>
          <div class='mt-2'>
            <input type='text' name='name' required placeholder='Name' className='input-field block w-80 rounded-md border border-white border-opacity-10 bg-white bg-opacity-10' />
          </div>
